...
\begin{itemize}
    ...
    En este reporte aprendimos a utilizar las interfaces de packet tracer, revisar las capas que tiene cada una de ellas,        tambien logramos obervar los trabajos en segundo plano que se esten haciendo, revisar protocolos http, stp, arc entre        otros mas segun lo que requiramos.
